<%@ Page Title="Segment Product" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master"
    AutoEventWireup="true" CodeFile="AdminSegmentProduct.aspx.cs" Inherits="AdminSegmentProduct"
                ...
                <div style="overflow: auto; height: 200px; width: 767px; position: relative; padding-top: 22px;">
                   <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    ...
                    <asp:GridView ID="gv_segment" runat="server" CellPadding="4" ForeColor="#333333"
                        GridLines="None" OnRowCancelingEdit="gv_segment_RowCancelingEdit" OnRowDataBound="gv_segment_RowDataBound"
                        OnRowDeleting="gv_segment_RowDeleting" OnRowEditing="gv_segment_RowEditing" OnRowUpdating="gv_segment_RowUpdating"
                        OnSelectedIndexChanging="gv_segment_SelectedIndexChanging" Style="font-size: 12px;">
                ...
                <div style="overflow: auto; height: 200px; width: 767px; position: relative; padding-top: 22px;">
                   <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                    ...
                    <asp:GridView ID="gv_product" runat="server" CellPadding="4" ForeColor="#333333"
                        GridLines="None" OnRowCancelingEdit="gv_product_RowCancelingEdit" OnRowDataBound="gv_product_RowDataBound"
                        OnRowDeleting="gv_product_RowDeleting" OnRowEditing="gv_product_RowEditing" OnRowUpdating="gv_product_RowUpdating" Style="font-size: 12px;">
                        <RowStyle BackColor="#EFF3FB" />
                        <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                        <PagerStyle BackColor="#2461BF" ForeColor="White" HorizontalAlign="Center" />
                        <HeaderStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" CssClass="Freezing"/>
                ...
                <tr>
                    <td>
                        <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                            ...
                            <Triggers>
                                <asp:PostBackTrigger ControlID="btn_addproduct" />
                            </Triggers>
                        </asp:UpdatePanel>
                    </td>
                </tr>
