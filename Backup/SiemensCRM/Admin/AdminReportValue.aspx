...
<%@ Page Title="ReportValue" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master"
    AutoEventWireup="true" CodeFile="AdminReportValue.aspx.cs" Inherits="Admin_ReportValue" EnableSessionState="ReadOnly" %>
...
<table>
            ...
            <tr>
               ...
               <tr>
                ...
                <tr>
                    ...
                    <asp:ImageButton ID="ImageButton1" runat="server" width="12" height="10" ImageUrl="../images/nkk_03.png" OnClientClick="getselectedString()" OnClick="btnSubmit_Click"   /> 
                    <asp:ImageButton ID="ImageButton4" runat="server" width="10" height="9" ImageUrl="../images/tablist2_03.png"  OnClick="btnCancel_Click"/></td>
                </tr>
                <tr>
                    <td colspan="3">
    ...
    <asp:HiddenField ID="hidReportId" runat="server" />
     <asp:HiddenField ID="hidCreateUser" runat="server" />
