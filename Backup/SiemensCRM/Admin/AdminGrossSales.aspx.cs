/*
 * File Name   : AdminGrossSales.aspx.cs
 * 
...
public partial class Admin_AdminGrossSales : System.Web.UI.Page
{
        ...
        if (dsPro.Tables[0].Rows.Count > 0 && dsOp.Tables[0].Rows.Count > 0)
        {
            ...
            for (int count = 0; count < dsOp.Tables[0].Rows.Count; count++)
            {
                ...
                if (ds[count].Tables[0].Rows.Count > 0)
                {
                    ...
                    //by yyan item8 20110623 add start 
                    //gvEur[count] = bindDataByOperation(dsEur[count], gvEur[count], str_OperationID, "<br />", ds_budgetEur, 1,1);
                    //gvEur1[count] = bindDataByOperation(dsEur1[count], gvEur1[count], str_OperationID, "", ds_budgetEur, 1,2);
                    //by yyan item8 20110623 add end 
                ...
                if (dsBookings[count].Tables[0].Rows.Count > 0)
                {
                    ...
                    //gvBookingsEur[count] = bindDataByOperation(dsBookingsEur[count], gvBookingsEur[count], str_OperationID, "", ds_budgetEur, 1,0);
                    //by yyan item8 20110623 add end
                    //by yyan 20100608 Item22 add start
