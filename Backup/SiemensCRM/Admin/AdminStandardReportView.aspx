<%@ Page Language="C#" Title="Report View List" MasterPageFile="~/Admin/AdminMasterPage.master"
    AutoEventWireup="true" CodeFile="AdminStandardReportView.aspx.cs" Inherits="AdminStandardReportView" %>
                ...
                <asp:TemplateField HeaderText="Action" HeaderStyle-HorizontalAlign="center">
                    <ItemTemplate>
                       ...
                       <%--  by yyan 20110817 itemW111 add start  --%> 
                        <asp:ImageButton ID="mbtnCancel" CommandName="CancelShare" AlternateText="CancelShare" CommandArgument='<%# DataBinder.Eval(Container.DataItem,"ID")%>'
