/*
 * File Name      : AdminRSMInfo.aspx.cs
 * 
...
public partial class Admin_AdminRSMInfo : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (type!=null)
        {
            ...
            if (type == "operation")
            {
                string insert_customer = "UPDATE [User_Operation] SET Deleted = 1 WHERE UserID = '" + getUserID() + "'";
                helper.ExecuteNonQuery(CommandType.Text, insert_customer, null);
                foreach (String var in a_keys)
                {
                    insert_customer = "INSERT INTO [User_Operation] VALUES(" + getUserID() + ",'" + var.Trim() + "',0)";
                    helper.ExecuteNonQuery(CommandType.Text, insert_customer, null);
                }
            ...
            {
                string insert_customer = "UPDATE [User_Country] SET Deleted = 1 WHERE UserID = '" + getUserID() + "'";
                helper.ExecuteNonQuery(CommandType.Text, insert_customer, null);
                foreach (String var in a_keys)
                {
                    insert_customer = "INSERT INTO [User_Country] VALUES(" + getUserID() + ",'" + var.Trim() + "',0)";
                    helper.ExecuteNonQuery(CommandType.Text, insert_customer, null);
                }
        ...
        /*by ryzhang 20110509 item47 add start*/
        this.lbtn_customer.Attributes.Add("onclick", "javascript:showDialog('AdminRSMInfoClickSelect.aspx?select=operation&userid=" + getUserID() + "','operation');");
        this.lbtn_country.Attributes.Add("onclick", "javascript:showDialog('AdminRSMInfoClickSelect.aspx?select=subregion&userid=" + getUserID() + "','subregion');");
        /*by ryzhang 20110509 item47 add end*/
    ...
    protected DataSet getcountryInfo()
    {
        ...
        //if (ds_country.Tables[0].Rows.Count < 16)
        //{
        //    this.div3.Style.Value = "";
        //}
        //else
        //{
        //    this.div1.Attributes.Add("Style", " overflow:auto;  height:530px ");
        //    this.div2.Attributes.Add("Style", " overflow:auto;  height:530px ");
        //    this.div3.Attributes.Add("Style", " overflow:auto;  height:530px ");
        //}
    ...
    protected void bindDataSource(GridView gridview, string str_caption, DataSet ds)
    {
        ...
        if (ds != null)
        {
            ...
            gridview.Width = Unit.Pixel(223);
            gridview.AutoGenerateColumns = false;
            //By FXW 20110510 ITEM  ADD Start
            gridview.AllowPaging = false;
            //By FXW 20110510 ITEM  ADD End
            //By FXW 20110510 ITEM  DEL Start
            //gridview.AllowPaging = true;
            //By FXW 20110510 ITEM  DEL End
    ...
    {
        /*by ryzhang 20110506 item47 del statr*/
        ...
        /*by ryzhang 20110506 item47 del stop*/
    }
