/*
* File Name   : AdminStandardReportResult.aspx.cs
* 
* Author      : yyan 
* 
...
using Resources;
public partial class AdminStandardReportResult : System.Web.UI.Page
{
    ...
    protected DataSet getAdministratorInfo(string strOrdey)
    {
        ...
        {
            sql_searchUser = sql.RepCompileSql(HidReportId.Value, getLoginRole(), "", "", strOrdey, sql.getSelectMeetingDate(Session["AdministratorID"].ToString()), Session["AdministratorID"].ToString());
        }
        else if (viewName.Equals("SalesBacklog"))
        {
            sql_searchUser = sql.RepCompileSqlBacklog(HidReportId.Value, getLoginRole(), strOrdey,sql.getSelectMeetingDate(Session["AdministratorID"].ToString()), Session["AdministratorID"].ToString());
        }
        else {
            sql_searchUser = sql.RepCompileSql(HidReportId.Value, getLoginRole(), "", "", strOrdey, Session["AdministratorID"].ToString());
        }
