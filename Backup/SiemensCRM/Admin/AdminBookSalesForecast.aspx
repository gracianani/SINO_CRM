<%@ Page Title="Forecast" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true"
    CodeFile="AdminBookSalesForecast.aspx.cs" Inherits="Admin_AdminBookSalesForecast" EnableSessionState="ReadOnly" %>
        ...
        <tr>
            <td colspan="2">
                <asp:Panel ID="panel_enter" runat="server" Visible="false">
                    ...
                    <br />
                    <br />
                    <%--by yyan itemw50 20110624 del start--%>
                    <%--<asp:LinkButton ID="lbtn_region" runat="server" OnClick="lbtn_region_Click">New Orders by Countries</asp:LinkButton>--%>
                    <%--by yyan itemw50 20110624 del end--%>
                    <%--by yyan itemw50 20110624 add start--%>
                    <asp:LinkButton ID="lbtn_region" runat="server" OnClick="lbtn_region_Click">New Orders by Key Countries</asp:LinkButton>
                    <%--by yyan itemw50 20110624 add end--%>
