<%@ Page Title="SO(Bookings By Sales Organization)" Language="C#" MasterPageFile="~/Assistant/AssistantMasterPage.master"
    AutoEventWireup="true" CodeFile="AssistantBookingBySalesOrg.aspx.cs" Inherits="Assistant_AssistantBooking"
        ...
        <table>
            <tr>
                <td colspan="15">
                    ...
                    <asp:DropDownList ID="ddlist_salesOrg" runat="server" Width="90px">
                    </asp:DropDownList>
                    &nbsp;&nbsp;
