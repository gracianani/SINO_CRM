<%@ Page Title="" Language="C#" MasterPageFile="~/Assistant/AssistantMasterPage.master" AutoEventWireup="true" CodeFile="AssistantModifyPassword.aspx.cs" Inherits="Assistant_AssistantModifyPassword" %>
...
<div align="center">
        <asp:Panel ID="Panel4" runat="server" BackColor="#CCCCCC" BorderColor="White" Height="170px"
            ...
            <div>
                <strong>
                    <asp:Label ID="lbl_welcom" runat="server" Text="Modify Password"></asp:Label>
                </strong>
            </div>
            <br />
            <br />
            <div>
                ...
                <asp:TextBox ID="tbox_refirmpassword" runat="server" Width="120px" MaxLength="12"
