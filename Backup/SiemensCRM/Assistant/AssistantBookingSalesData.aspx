<%@ Page Title="Booking Data" Language="C#" MasterPageFile="~/Assistant/AssistantMasterPage.master"
    AutoEventWireup="true" CodeFile="AssistantBookingSalesData.aspx.cs" Inherits="Assistant_AssistantBookSalesData"
    EnableSessionState="ReadOnly" EnableEventValidation="false" %>
    <%@ MasterType VirtualPath="~/Assistant/AssistantMasterPage.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    function showRSMData() {
        ...
        var UserID = '<%= Session["AssistantID"] %>'
    ...
    function showSO() {
        ...
        var date = new Date();
        var url = "AssistantBookingBySalesOrgBySegment.aspx?TimeFlag="+date.getFullYear()+date.getMonth()+date.getDate()+date.getHours()+date.getMinutes+date.getSeconds()+date.getMilliseconds() + paramStr;
        //window.showModalDialog(url, null, 'dialogHeight=550px;dialogWidth=900px;status=no;resizable=no;scroll=yes;help=no');
