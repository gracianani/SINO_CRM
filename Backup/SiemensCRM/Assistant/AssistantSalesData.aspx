<%@ Page Title="Actual Sales Data" Language="C#" MasterPageFile="~/Assistant/AssistantMasterPage.master" AutoEventWireup="true"
    CodeFile="AssistantSalesData.aspx.cs" Inherits="Assistant_AssistantSalesData" %>
    ...
    <table>
        ...
        <tr>
            <td>
                ...
                <asp:DropDownList ID="ddlist_segment" runat="server" AutoPostBack="True">
                </asp:DropDownList>
                &nbsp;&nbsp;&nbsp;&nbsp;
