...
public partial class Executive_ExecutiveBookSalesData : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            log.WriteLog(LogUtility.LogErrorLevel.LOG_ACCESS, "ExecutiveBookingSalesData Access.");
    ...
    */
    ...
    protected DataSet getSegmentInfo(string str_salesOrgID)
    {
        ...
        //                    + " WHERE UserID = " + Session["ExecutiveID"].ToString() + " AND [Segment].deleted=0 AND [User_Segment].deleted=0 ) "
    ...
    protected string getExecutiveID()
    {
        return Session["ExecutiveID"].ToString().Trim();
    }
    ...
    private string getCountrySQL()
    {
        ...
        **/
        ...
        string query_country = " SELECT [SubRegion].ID AS SubRegion"
                    ...
                    + " WHERE [User_Country].UserID  = '" + getExecutiveID() + "'"
    ...
    protected void btn_search_Click(object sender, EventArgs e)
    {
        ...
        if (this.ddlist_RSM.Items.FindByValue(Session["ExecutiveID"].ToString()) != null)
        {
            this.ddlist_RSM.SelectedValue = Session["ExecutiveID"].ToString();
        }
