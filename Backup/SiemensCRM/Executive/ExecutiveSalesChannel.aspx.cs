...
public partial class Executive_ExecutiveSalesChannel : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            log.WriteLog(LogUtility.LogErrorLevel.LOG_ACCESS, "ExecutiveSalesChannel Access.");
    ...
    protected void bindDataSource(DataSet ds_channel)
    {
        ...
        //By Wsy 20110511 ITEM 18 DEL Start 
        //gv_channel.AllowPaging = true;
        //By Wsy 20110511 ITEM 18 DEL End 

        //By Wsy 20110511 ITEM 18 ADD Start 
        gv_channel.AllowPaging = false;
        //By Wsy 20110511 ITEM 18 ADD End
    ...
    {
        string str_args = "'ExecutiveHelp.aspx'" + ",'Help', 'height=500,width=800,top=100,left=200,toolbar=no,status=no, menubar=no,location=no,resizable=no,scrollbars=yes'";
