/*
 * File Name   : ExecutiveCountry.aspx.cs
 * 
...
public partial class Executive_ExecutiveCountryCustomer : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            log.WriteLog(LogUtility.LogErrorLevel.LOG_ACCESS, "ExecutiveCountry Access.");
            setSearchOption();
