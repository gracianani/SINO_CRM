<%@ Page Title="OP-BKG(Operational Booking)" Language="C#" MasterPageFile="~/Executive/ExecutiveMasterPage.master"
    AutoEventWireup="true" CodeFile="ExecutiveOperationalBookings.aspx.cs" Inherits="Executive_ExecutiveOperationalBookings" EnableEventValidation="false" %>
    ...
    <div>
        <table>
            <tr>
                ...
                <td width="100" align="left">
                    <asp:LinkButton ID="lbtn_opBKG" runat="server" Font-Underline="False" OnClick="lbtn_opBKG_Click"
                        Font-Bold="True">> OP - BKG</asp:LinkButton>
                </td>
                <td width="100" align="left">
