/*
 * File Name   : ExecutiveBookingBySalesOrg.aspx.cs
 * 
 * Description : search booking data by sales organization
 * 
 * Author      : Wang Jun
 * 
 * Modify Date : 2010-04-02
 * 
 * Problem     : none
 * 
 * Version     : Release (1.0)
...
public partial class Executive_ExecutiveBooking : System.Web.UI.Page
{
    ...
    {
        string query_segment = "SELECT Abbr FROM [Segment]"
    ...
    {
        Response.Redirect("~/Executive/ExecutiveGrossSales.aspx?SegmentID=" + getSegmentID());
    }

    protected void lbtn_grBKG_Click(object sender, EventArgs e)
    {
        Response.Redirect("~/Executive/ExecutiveGrossBookings.aspx?SegmentID=" + getSegmentID());
    }

    protected void lbtn_opSales_Click(object sender, EventArgs e)
    {
        Response.Redirect("~/Executive/ExecutiveOperationSales.aspx?SegmentID=" + getSegmentID());
    }

    protected void lbtn_opBKG_Click(object sender, EventArgs e)
    {
        Response.Redirect("~/Executive/ExecutiveOperationalBookings.aspx?SegmentID=" + getSegmentID());
    }

    protected void lbtn_SO_Click(object sender, EventArgs e)
    {
        Response.Redirect("~/Executive/ExecutiveBookingBySalesOrg.aspx?SegmentID=" + getSegmentID());
    }
