<%@ Page Title="Booking Data" Language="C#" MasterPageFile="~/Executive/ExecutiveMasterPage.master"
    AutoEventWireup="true" CodeFile="ExecutiveBookingSalesData.aspx.cs" Inherits="Executive_ExecutiveBookSalesData"
    EnableSessionState="ReadOnly" EnableEventValidation="false" %>
    <%@ MasterType VirtualPath="~/Executive/ExecutiveMasterPage.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    function showRSMData() {
        ...
        var UserID = '<%= Session["ExecutiveID"] %>'
    ...
    function showSO() {
        ...
        var date = new Date();
        var url = "ExecutiveBookingBySalesOrgBySegment.aspx?TimeFlag="+date.getFullYear()+date.getMonth()+date.getDate()+date.getHours()+date.getMinutes+date.getSeconds()+date.getMilliseconds() + paramStr;
        //window.showModalDialog(url, null, 'dialogHeight=550px;dialogWidth=900px;status=no;resizable=no;scroll=yes;help=no');
