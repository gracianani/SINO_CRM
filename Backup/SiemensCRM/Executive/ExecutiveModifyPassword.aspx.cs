...
public partial class Executive_ExecutiveModifyPassword : System.Web.UI.Page
{
    ...
    private bool checkPassword()
    {
        ...
        //BY lhy 20110519 ITEM W6 DEL Start
          /* if (str_password.Equals(str_refirm))
                return true;
            else
                return false;
          */
        //BY lhy 20110519 ITEM W6 DEL End

        //BY lhy 20110519 ITEM W6 ADD Start
        ...
        //BY lhy 20110519 ITEM W6 ADD End
    }
    ...
    protected void btn_ok_Click(object sender, EventArgs e)
    {
        ...
        {   
            ...
            {
                lbl_error.Text = "Passwords can not be Null.";
            }
            else {
