/*
 * File Name   : SalesOrgMgrSalesChannel.aspx.cs
 * 
...
public partial class SalesOrgMgr_SalesOrgMgrSalesChannel : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            log.WriteLog(LogUtility.LogErrorLevel.LOG_ACCESS, "SalesOrgMgrSalesChannel Access.");
