/*
 * File Name   : SalesOrgMgrCountry.aspx.cs
 * 
...
public partial class SalesOrgMgr_SalesOrgMgrCountryCustomer : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            log.WriteLog(LogUtility.LogErrorLevel.LOG_ACCESS, "SalesOrgMgrCountry Access.");
            setSearchOption();
