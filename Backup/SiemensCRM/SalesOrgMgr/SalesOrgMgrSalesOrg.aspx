<%@ Page Title="Sales Organization" Language="C#" MasterPageFile="~/SalesOrgMgr/SalesOrgMgrMasterPage.master"
    AutoEventWireup="true" CodeFile="SalesOrgMgrSalesOrg.aspx.cs" Inherits="SalesOrgMgr_SalesOrgMgrSalesOrg"
                ...
                <td align="left">
                    <div style="overflow: auto; height: 400px; width: 820px; position: relative; padding-top: 22px;">
                        <asp:UpdatePanel ID="UpdatePanel8" runat="server" UpdateMode="Conditional">
                            <contenttemplate>
                        <asp:GridView ID="gv_salsOrg" runat="server" CellPadding="4" ForeColor="#333333" Style="font-size: 12px;"
                            GridLines="None" OnPageIndexChanging="gv_salsOrg_PageIndexChanging" OnRowDeleting="gv_salsOrg_RowDeleting"
                            OnRowDataBound="gv_salsOrg_RowDataBound" OnSelectedIndexChanging="gv_salsOrg_SelectedIndexChanging"
                            OnRowCancelingEdit="gv_salsOrg_RowCancelingEdit1" OnRowEditing="gv_salsOrg_RowEditing"
                            OnRowUpdating="gv_salsOrg_RowUpdating">
                        ...
                        <tr>
                            ...
                            <div style="overflow: auto; height: 200px; width: 310px; position: relative; padding-top: 22px;">
                                <asp:GridView ID="gv_Segment" runat="server" CellPadding="4" ForeColor="#333333"
                                    GridLines="None" PageSize="10" OnRowDataBound="gv_Segment_RowDataBound" OnRowDeleting="gv_Segment_RowDeleting"
                                    OnPageIndexChanging="gv_Segment_PageIndexChanging" Style="font-size: 12px;">
                                    <RowStyle BackColor="#EFF3FB" />
                                    <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                                    <PagerStyle BackColor="#2461BF" ForeColor="White" HorizontalAlign="Center" />
                                    <HeaderStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" CssClass="Freezing"/>
