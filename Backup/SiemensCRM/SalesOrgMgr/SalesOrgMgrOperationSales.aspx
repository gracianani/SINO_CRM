<%@ Page Title="OP-Sales(Operation Sales)" Language="C#" MasterPageFile="~/SalesOrgMgr/SalesOrgMgrMasterPage.master"
    AutoEventWireup="true" CodeFile="SalesOrgMgrOperationSales.aspx.cs" Inherits="SalesOrgMgr_Default" EnableEventValidation="false" %>
