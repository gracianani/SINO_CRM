...
public partial class SalesOrgMgr_SalesOrgMgrBookingBySalesOrgBySegment : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!string.Equals(getRoleID(getRole()), "3"))
        {
        ...
        if (!IsPostBack)
        {
            log.WriteLog(LogUtility.LogErrorLevel.LOG_ACCESS, "SalesOrgMgrBookingBySalesOrg Access.");
            setDate();
    ...
    protected GridView showBookingsByProduct(DataSet ds, GridView gv, string header)
    {
        if (ds != null)
        {
            ...
            catch
            {
                ...
                Response.Redirect("~/SalesOrgMgr/SalesOrgMgrError.aspx");
            }
