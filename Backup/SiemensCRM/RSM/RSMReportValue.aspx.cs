...
public partial class RSM_ReportValue : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            hidUserId.Value = Session["RSMID"].ToString();
        }
        else
        {
            hidUserId.Value = "";
    ...
    protected DataTable getViewNameByName()
    {
        ...
        if (ddlViewName.SelectedItem != null)
        {
            sql = "SELECT * FROM " + ddlViewName.SelectedItem.Text;
            dt = helper.GetDataSetStru(sql);
        }
        return dt;
    }
    ...
    { lock(isSubmit)
        ...
        Response.Redirect("RSMReportView.aspx");
