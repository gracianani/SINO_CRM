/*
 *   FileName        :  RSMBookingBySalesOrg.aspx.cs
 * 
 *   Description     :  Get booking data by sales organization by operation
 * 
 *   Author          :  Wang Jun
 * 
...
public partial class RSM_Default : System.Web.UI.Page
{
    ...
    protected string getSegmentDec()
    {
        string query_segment = "SELECT Description FROM [Segment]"
                            + " WHERE Deleted = 0 AND ID = " + Request.QueryString["SegmentID"];
    ...
    protected void btn_search_Click(object sender, EventArgs e)
    {
        ...
        label_headdescription.Text = getSegmentDec() + " -Booking in " + getMeetingDateYear() + " BY SALES ORGANIZATION";
