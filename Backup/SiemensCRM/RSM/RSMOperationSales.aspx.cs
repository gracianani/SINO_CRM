/*
 *  FileName       :  RSMOperationSales.aspx.cs
 * 
...
public partial class RSM_Default : System.Web.UI.Page
{
    ...
    /// <summary>
    ///  Make operation information bind to DropDownList
    /// </summary>
    ...
    /// <summary>
    ///  Get sales forecast and budget of one sales organization in backlog year
    /// </summary>
    /// <param name="ds">DataSet </param>
    /// <param name="salesOrgID">SalesOrgID</param>
    /// <param name="backlogY">backlogY</param>
    //by yyan item8 20110614 del start
    ...
    //by yyan item8 20110614 add end
    {
        ...
        if (dsPro.Tables[0].Rows.Count > 0 && dsSaleOrg.Tables[0].Rows.Count > 0)
        {
            ...
            DataSet dsOp = sql.getSalesDataByOperation(dsPro, ddlist_operation.SelectedItem.Value, getSegmentID(),0);
            ...
            if (dsOp.Tables[0].Rows.Count > 0)
            {
                ...
                //by yyan item8 20110614 del end
                //by yyan item8 20110614 add start
                gvOp = bindDataBySalesOrgByOperation(dsOp, gvOp, "<br />", "", 0, true);
                gvOp1 = bindDataBySalesOrgByOperation(dsOp1, gvOp1, "", "", 0, false);
                //by yyan item8 20110614 add end
            }
