...
<%@ Page Title="ReportValue" Language="C#" MasterPageFile="~/RSM/RSMMasterPage.master"
    AutoEventWireup="true" CodeFile="RSMReportValue.aspx.cs" Inherits="RSM_ReportValue" EnableSessionState="ReadOnly" %>
    ...
    <td align="left" valign="top" colspan="4">
        <fieldset class="fie">
            ...
            <tr>
               ...
               <tr>
                <td style="width: 10px" align="left" valign="top"></td>
                <td align="right"><asp:Label ID="lblDepiction" runat="server" Text="Depiction:"></asp:Label></td>
