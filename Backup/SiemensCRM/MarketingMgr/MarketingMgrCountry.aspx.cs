/*
 * File Name   : MarketingMgrCountry.aspx.cs
 * 
...
public partial class MarketingMgr_MarketingMgrCountryCustomer : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            log.WriteLog(LogUtility.LogErrorLevel.LOG_ACCESS, "MarketingMgrCountry Access.");
            setSearchOption();
