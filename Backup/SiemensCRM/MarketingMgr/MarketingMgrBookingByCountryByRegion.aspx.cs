...
public partial class MarketingMgr_AdminBookingByCountryByRegion : System.Web.UI.Page
{
    ...
    {
        if (getRoleID(getRole()) == "0" || getRoleID(getRole()) == "2")
        { 
        ...
        if (!IsPostBack)
        {
            log.WriteLog(LogUtility.LogErrorLevel.LOG_ACCESS, "MarketingMgrBookingByCountryByRegion Access.");
            //by ryzhang item49 20110519 del start 
            //meeting.setDate();
            //by ryzhang item49 20110519 del end 
            //by ryzhang item49 20110519 add start 
    ...
    {
        string meetingData = string.Empty;
        ...
        {
            meetingData = "This report is related to the meeting date " + ds_date.Tables[0].Rows[0][0].ToString();
        }
        else
        {
            meetingData = "There is no meeting date selected!";
        }
        
        TableRow tr5 = new TableRow();
        table_bookingbycountry.Rows.Add(tr5);
        TableCell tc5 = new TableCell();
        tc5.Text = meetingData;
