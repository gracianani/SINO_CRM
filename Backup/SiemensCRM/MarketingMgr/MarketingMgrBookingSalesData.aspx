<%@ Page Title="Booking Data" Language="C#" MasterPageFile="~/MarketingMgr/MarketingMgrMasterPage.master"
    AutoEventWireup="true" CodeFile="MarketingMgrBookingSalesData.aspx.cs" Inherits="MarketingMgr_MarketingMgrBookSalesData"
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    function showRSMData() {
        ...
        var UserID = '<%= Session["GeneralMarketingMgrID"] %>'
    ...
    function showSO() {
        ...
        var date = new Date();
        var url = "MarketingMgrBookingBySalesOrgBySegment.aspx?TimeFlag="+date.getFullYear()+date.getMonth()+date.getDate()+date.getHours()+date.getMinutes+date.getSeconds()+date.getMilliseconds() + paramStr;
        //window.showModalDialog(url, null, 'dialogHeight=550px;dialogWidth=900px;status=no;resizable=no;scroll=yes;help=no');
