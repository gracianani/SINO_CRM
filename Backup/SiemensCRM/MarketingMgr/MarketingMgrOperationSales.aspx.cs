/*
 *  FileName       :  MarketingMgrOperationSales.aspx.cs
 * 
...
public partial class MarketingMgr_Default : System.Web.UI.Page
{
    ...
    //by yyan item8 20110614 add end
    {
        ...
        if (dsPro.Tables[0].Rows.Count > 0 && dsSaleOrg.Tables[0].Rows.Count > 0)
        {
            ...
            //BY lhy 20110517 ADD ITEM lhy1 Start
            int index = 0;
            //BY lhy 20110517 ADD ITEM lhy1 End
            ...
            for (int count = 0; count < dsSaleOrg.Tables[0].Rows.Count; count++)
            {
                ...
                if (ds[count].Tables[0].Rows.Count > 0)
                {
                    ...
                    //BY lhy 20110516 ADD ITEM lhy1 Start
                    //by yyan item8 20110614 del start
                    ...
                    //by yyan itemw93 add end 
                    index++;
                    //BY lhy 20110516 ADD ITEM lhy1 End
