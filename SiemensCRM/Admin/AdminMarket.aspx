<%@ Page Title="Market" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master"
    AutoEventWireup="true" CodeFile="AdminMarket.aspx.cs" Inherits="Admin_AdminMarket" %>
            ...
            <asp:UpdatePanel ID="UpdatePanel33" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    ...
                    <asp:GridView ID="gv_market" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None"
                        ...
                        OnRowDataBound="gv_market_RowDataBound" OnRowDeleting="gv_market_RowDeleting"
                        OnRowEditing="gv_market_RowEditing" OnRowUpdating="gv_market_RowUpdating">
