<%@ Page Language="C#" Title="Report View List" MasterPageFile="~/Admin/AdminMasterPage.master"
    AutoEventWireup="true" CodeFile="AdminReportView.aspx.cs" Inherits="Admin_AdminReportView" %>
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Action" HeaderStyle-HorizontalAlign="center">
                    <ItemTemplate>
                        ...
                        <asp:ImageButton ID="mbtnShare" CommandName="Share" AlternateText="Share" CommandArgument='<%# DataBinder.Eval(Container.DataItem,"ID")%>'
                            ImageUrl="~/images/gx1.png" runat="server"  OnClientClick="return share();"/>
                             <asp:ImageButton ID="mbtnCopy" CommandName="Copy" AlternateText="Copy" CommandArgument='<%# DataBinder.Eval(Container.DataItem,"ID")%>'
                            ImageUrl="~/images/copy.png" runat="server" />
                        <%--BY yyan item 53 20110513 add end --%>
                        <asp:HiddenField ID="hidFlagShare" runat="server" Value='<%# Eval("FlagShare") %>' />
