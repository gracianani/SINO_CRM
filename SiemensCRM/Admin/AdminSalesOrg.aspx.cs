/*
 * File Name     : AdminSalesOrg.aspx.cs
 * 
 ...
 * 
 * Problem       : only check displaying information
 * 
 * Version       : Release (1.0)
 */
...
public partial class Admin_AdminSalesOrg : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            log.WriteLog(LogUtility.LogErrorLevel.LOG_ACCESS, "AdminSalesOrg Access.");
            initVisible();
            //By SJ 20110519 ADD Start 
            clearCentent();
            //By SJ 20110519 ADD End
            getsearchIN();
    ...
    protected DataSet getRSMInfo()
    {
        ...
        //                + " WHERE [SalesOrg].ID = " + this.hidSalesOrgID.Value + " AND [SalesOrg].Deleted = 0 AND [User].Deleted = 0 AND [SalesOrg_User].Deleted = 0"
    ...
    protected DataSet getSegmentInfo()
    {
        string query_segment = "SELECT [Segment].ID,[Segment].Abbr AS Segment "
                            ...
                            + " WHERE [SalesOrg].Deleted = 0 AND [Segment].Deleted = 0 AND [SalesOrg].ID = " + this.hidSalesOrgID.Value + " AND [SalesOrg_Segment].Deleted = 0"
    ...
    protected void gv_salsOrg_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        //By Sj 20110513 Update Start
        //if (ds_RSM == null && ds_Segment == null)
        if (ds_RSM.Tables[0].Rows.Count == 0 && ds_Segment.Tables[0].Rows.Count == 0)
        //By Sj 20110513 Update End
        {
            ...
            //By SJ 20110513 ADD Start 
            ddlist_in_SelectedIndexChanged(sender, e);
            //By SJ 20110513 ADD End 
            if (count > 0)
            {
                label_salesOeg_edit_del.ForeColor = System.Drawing.Color.Green;
           ...
           //By SJ 20110513 Update Strat
           // label_salesOeg_edit_del.Text = "Because of being not null," + str_name + " cannot be deleted.";
            label_salesOeg_edit_del.Text = "Because of staff and segment being not null," + str_name + " cannot be deleted.";
           //By SJ 20110513 Update End
        panel_select.Visible = false;
        bindDataSource();
    }
    ...
    protected void gv_salsOrg_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
    {
       ...
       // By SJ 20110511 ITEM  ADD Start
        ...
        this.hidSalesOrgID.Value = gv_salsOrg.Rows[index].Cells[0].Text;
    ...
    protected void gv_RSM_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        string del_RSM = "UPDATE [SalesOrg_User] SET Deleted = 1 WHERE UserID = " + str_ID + " AND SalesOrgID = " + this.hidSalesOrgID.Value;
        //By SJ 20110513 Update End
        ...
        getRSMInfo(this.hidSalesOrgID.Value);
        bindDataSource();
    }
    ...
    {
        string query_RSM = "SELECT [User].UserID, [User].Abbr,[Role].name FROM [User],[Role] WHERE [User].Roleid=[Role].id and [User].Deleted = 0 AND ([User].RoleID = 4 OR [User].RoleID = 3 OR [User].RoleID = 2)"
                           + " AND UserID NOT IN"
                           + " (SELECT [User].UserID "
        ...
        if (ds_RSM.Tables.Count > 0)
        {
            if (ds_RSM.Tables[0].Rows.Count > 0)
            {
                ...
                {
                    this.ddlist_RSM.Items.Add(new ListItem(dt_RSM.Rows[indexRSM][1].ToString() + "(" + dt_RSM.Rows[indexRSM][2].ToString() + ")", dt_RSM.Rows[indexRSM][0].ToString()));
                    indexRSM++;
                }
    ...
    {
        //By SJ 20110518 ADD Start 
        clearCentent();
        //By SJ 20110518 ADD End
        ...
        if (str_ID != null)
        {
            string insert_salesOrg_RSM = "INSERT INTO [SalesOrg_User] VALUES(" + this.hidSalesOrgID.Value + "," + str_ID + " ,0)";
    ...
    protected void gv_Segment_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        string del_segment = "UPDATE [SalesOrg_Segment] SET Deleted = 1 "
                            + " WHERE SegmentID = " + str_segmentID + " AND SalesOrgID = " + this.hidSalesOrgID.Value;
        ...
        getSegmentInfo(this.hidSalesOrgID.Value);
        bindDataSource();
    }
    ...
    protected void btn_addSegment_Click(object sender, EventArgs e)
    {
        ...
        if (str_ID != null)
        {
            string insert_salesOrg_segment = "INSERT INTO [SalesOrg_Segment] VALUES(" + this.hidSalesOrgID.Value + "," + str_ID + " ,0)";
    ...
    //By SJ 20110519 Item 18 Add Start   
    protected void clearCentent()
    {
       //By SJ 20110519 Item 18 Del Start  
       //ddlist_find.SelectedValue = "";
       //By SJ 20110519 Item 18 Del End  
       label_add.Text = "";
       label_salesOrg_add.Text = "";
       label_caption.Text = "";
       label_RSM_del.Text = "";
    ...
    //By SJ 20110519 Item 18 Add End
}
