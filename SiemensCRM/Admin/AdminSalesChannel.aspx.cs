/*
 * File Name   : AdminSalesChannel.aspx.cs
 * 
 * Description : Add, edit and delete a sales channel.
 * 
 * Author      : Wang Jun
 * 
...
public partial class Admin_AdminSalesChannel : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            log.WriteLog(LogUtility.LogErrorLevel.LOG_ACCESS, "AdminSalesChannel Access.");
    ...
    {
        //By Wsy 20110518 ITEM 18 ADD Start
        label_del.Text = "";
        //By Wsy 20110518 ITEM 18 ADD End
        lbtn_channel.Text = "Add sales channel";
        lbtn_channel.Enabled = true;
        panel_addchannel.Visible = false;
