<%@ Page Title="Operation" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master"
    AutoEventWireup="true" CodeFile="AdminOperation.aspx.cs" Inherits="AdminOperation"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div align="center">
     ...
     <div style="overflow: auto; height: 220px; width: 767px; position: relative; padding-top: 22px;">
    ...
    <asp:UpdatePanel ID="UpdatePanel3" runat="server">
        ...
        <div>
            <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                ...
                <Triggers>
                    <asp:PostBackTrigger ControlID="btn_AddOperation" />
                </Triggers>
                <Triggers>
