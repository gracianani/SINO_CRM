<%@ Page Title="Country" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master"
    AutoEventWireup="true" CodeFile="AdminCountry.aspx.cs" Inherits="Admin_AdminCountryCustomer"
                        ...
                        <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                <asp:GridView ID="gv_option" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None"
                                    OnPageIndexChanging="gv_option_PageIndexChanging" OnRowDataBound="gv_option_RowDataBound"
                                    OnRowDeleting="gv_option_RowDeleting" Style="font-size: 12px;" OnSelectedIndexChanging="gv_option_SelectedIndexChanging">
