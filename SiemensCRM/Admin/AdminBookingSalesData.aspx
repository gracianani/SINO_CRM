<%@ Page Title="Booking Data" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master"
    AutoEventWireup="true" CodeFile="AdminBookingSalesData.aspx.cs" Inherits="Admin_AdminBookSalesData"
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <%--by ryhang 20110512 item4 add start--%>
...
//	        var flowtab3 = new flowThTable("outbox3",1);
//	        flowtab3.creatTable(400);
        }
    );
    ...
    function showRSMData() {
        ...
        paramStr = "&SalesOrgID=" + SalesOrgID + "&SegmentID=" + SegmentID + "&RSMID=" + RSMID + "&CountryID=" + CountryID + "&ConvertFlag=" + ConvertFlag;
        var date = new Date();
        ...
        //window.showModalDialog(url, null, 'dialogWidth:' + window.screen.availWidth + 'px;dialogHeight:' + window.screen.availHeight +'px;dialogLeft=0;dialogTop=0;scroll=yes;resizable=yes;status=no;help:no');
    ...
    function showSO() {
        ...
        var date = new Date();
        var url = "AdminBookingBySalesOrgBySegment.aspx?TimeFlag="+date.getFullYear()+date.getMonth()+date.getDate()+date.getHours()+date.getMinutes+date.getSeconds()+date.getMilliseconds() + paramStr;
        //window.showModalDialog(url, null, 'dialogWidth:' + window.screen.availWidth + 'px;dialogHeight:' + window.screen.availHeight +'px;dialogLeft=0;dialogTop=0;scroll=yes;resizable=yes;status=no;help:no');
    ...
    <%--by ryhang 20110512 item4 add end--%>
</asp:Content>
                        ...
                        <tr>
                            <td colspan="3">
                                ...
                                <asp:LinkButton ID="lbtn_editRSM" runat="server" Font-Bold="True" Font-Underline="False"
                                    OnClick="lbtn_editRSM_Click">Edit New Orders-></asp:LinkButton>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                ...
                                <br />
                                To view RSM bookings data, click <a id="aRSM" href="javascript:showRSMData();" style="font-weight: bold; text-decoration:none;">
                                    -> RSM Data </a>
                            </td>
                            <td>
                    ...
                    <table width="550">
                        <tr>
                            <td align="left" valign="top">
                                ...
                                <%--<div id="outbox3">
                                    <asp:GridView ID="gvTotalByCountry" runat="server" CellPadding="4" ForeColor="#333333"
