/*
 * File Name    : AdminCurrency.aspx.cs
 * 
 * Description  : Use for add current rate and next rate of the meeting, modify or delete previous rate
 * 
 * Author       : Wangjun
 * 
...
public partial class Admin_AdminCurrency : System.Web.UI.Page
{
    ...
    protected void btn_Addcurrency_Click(object sender, EventArgs e)
    {
        ...
        string str_currentrate = tbox_rate.Text.Trim().Replace(',', '.');
        string str_nextrate = tbox_rate2.Text.Trim().Replace(',', '.');
    ...
    protected void gv_currency_RowEditing(object sender, GridViewEditEventArgs e)
    {
        ...
        this.panel_addcurrency.Visible = false;
    }

    protected void gv_currency_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        string str_currentrate = ((TextBox)(gv_currency.Rows[e.RowIndex].Cells[2].Controls[0])).Text.ToString().Trim().Replace(',', '.');
        string str_nextrate = ((TextBox)(gv_currency.Rows[e.RowIndex].Cells[3].Controls[0])).Text.ToString().Trim().Replace(',', '.');
