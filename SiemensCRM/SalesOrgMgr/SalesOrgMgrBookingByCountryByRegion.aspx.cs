 ...
 * 
 * Description : Get booking data by region
 * 
 * Author      : Wang Jun
 * 
...
public partial class SalesOrgMgr_SalesOrgMgrBookingByCountryByRegion : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            log.WriteLog(LogUtility.LogErrorLevel.LOG_ACCESS, "AdminBookingByCountryByRegion Access.");
            //by ryzhang item49 20110519 del start 
            //meeting.setDate();
            //by ryzhang item49 20110519 del end 
            //by ryzhang item49 20110519 add start 
    ...
    {
        string query_segment = "SELECT ID,Abbr"
                            + " FROM [Segment] "
                            + " WHERE Deleted = 0"
                            + " ORDER BY Abbr ASC";
