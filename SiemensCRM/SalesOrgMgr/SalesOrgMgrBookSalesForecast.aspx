<%@ Page Title="Forecast" Language="C#" MasterPageFile="~/SalesOrgMgr/SalesOrgMgrMasterPage.master" AutoEventWireup="true"
    CodeFile="SalesOrgMgrBookSalesForecast.aspx.cs" Inherits="SalesOrgMgr_SalesOrgMgrBookSalesForecast" EnableSessionState="ReadOnly" %>
