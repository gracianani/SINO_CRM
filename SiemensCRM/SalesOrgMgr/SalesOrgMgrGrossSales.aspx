<%@ Page Title="GR-Sales(Gross Sales)" Language="C#" MasterPageFile="~/SalesOrgMgr/SalesOrgMgrMasterPage.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="SalesOrgMgrGrossSales.aspx.cs" Inherits="SalesOrgMgr_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   <div>
    ...
    <div style="width: 830px; overflow: scroll; height: 450px;">
        <table>
            <tr>
                <td>
                    *****************************************************************************************
