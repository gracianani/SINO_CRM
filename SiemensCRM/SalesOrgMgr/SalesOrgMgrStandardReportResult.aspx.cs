/*
* File Name   : SalesOrgMgrStandardReportResult.aspx.cs
* 
* Author      : yyan 
* 
...
using Resources;
public partial class SalesOrgMgrStandardReportResult : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            log.WriteLog(LogUtility.LogErrorLevel.LOG_ACCESS, "SalesOrgMgrAccountProfile Access.");
    ...
    protected DataSet getAdministratorInfo(string strOrdey)
    {
        ...
        {
            sql_searchUser = sql.RepCompileSql(HidReportId.Value, getLoginRole(), "", "", strOrdey, sql.getSelectMeetingDate(Session["GeneralSalesOrgMgrID"].ToString()), Session["GeneralSalesOrgMgrID"].ToString());
        }
        else if (viewName.Equals("SalesBacklog"))
        {
            sql_searchUser = sql.RepCompileSqlBacklog(HidReportId.Value, getLoginRole(), strOrdey, sql.getSelectMeetingDate(Session["GeneralSalesOrgMgrID"].ToString()), Session["GeneralSalesOrgMgrID"].ToString());
        }
        else {
            sql_searchUser = sql.RepCompileSql(HidReportId.Value, getLoginRole(), "", "", strOrdey, Session["GeneralSalesOrgMgrID"].ToString());
        }
    ...
    private string getLoginRole()
    {
        ...
        {
            strReturn = Session["GeneralSalesOrgMgrID"].ToString().Trim();
        }
        return strReturn;
    }
