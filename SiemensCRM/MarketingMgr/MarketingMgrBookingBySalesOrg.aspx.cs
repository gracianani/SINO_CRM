/*
 * File Name   : MarketingMgrBookingSalesData.aspx.cs
 * 
 * Description : 
 * 
 * Author      : Wang Jun
 * 
 * Modify Date : 2010.3.29
 * 
 * Problem     : none
 * 
 * End Date    : 
...
public partial class MarketingMgr_MarketingMgrBooking : System.Web.UI.Page
{
    ...
    protected string getSegmentDec()
    {
        string query_segment = "SELECT Description FROM [Segment]"
                            + " WHERE ID = " + Request.QueryString["SegmentID"]
                            + " AND Deleted=0 ";
