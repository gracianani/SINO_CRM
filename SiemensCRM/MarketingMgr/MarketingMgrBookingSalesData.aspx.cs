...
public partial class MarketingMgr_MarketingMgrBookSalesData : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            log.WriteLog(LogUtility.LogErrorLevel.LOG_ACCESS, "MarketingMgrBookingSalesData Access.");
    ...
    protected DataSet getSalesOrgInfo()
    {
        ...
        string query_salesOrg = "SELECT [SalesOrg].Name, [SalesOrg].Abbr, [SalesOrg].ID FROM [SalesOrg] INNER JOIN [SalesOrg_User]"
                              ...
                              + " WHERE [SalesOrg].Deleted = '0' AND [SalesOrg_User].Deleted = '0' AND [SalesOrg_User].UserID = " + getGeneralMarketingMgrID()
    ...
    */
    ...
    private string getCountrySQL()
    {
        ...
        string query_country = " SELECT [SubRegion].ID AS SubRegion"
                    ...
                    + " WHERE [User_Country].UserID  = '" + getGeneralMarketingMgrID() + "'"
    ...
    {
        //string query_country = "SELECT [Country].ID, [Country].ISO_Code "
        //                    + " FROM COUNTRY INNER JOIN [Bookings] ON [Bookings].CountryID=[Country].ID "
        //                    + " WHERE SegmentID = " + ddlist_segment.SelectedItem.Value
    ...
    protected DataSet getRSmInfo(string str_salesOrgID, string str_segmentID)
    {
        ...
        //by yyan itemw150 20110921 edit start 
        sql.AppendLine("   [User].Alias + '(' +Role.name +')' ");
        //by yyan itemw150 20110921 edit end 
        sql.AppendLine(" FROM ");
        ...
        sql.AppendLine("   AND ([User].RoleID=3 OR [User].RoleID=4 OR [User].UserID=" + getGeneralMarketingMgrID() + ") ");
    ...
    {
        string query_RSM = " SELECT Abbr FROM [User] WHERE UserID = '" + str_userID + "' AND Deleted=0";
    ...
    protected void btn_search_Click(object sender, EventArgs e)
    {
        ...
        if (this.ddlist_RSM.Items.FindByValue(Session["GeneralMarketingMgrID"].ToString()) != null)
        {
            this.ddlist_RSM.SelectedValue = Session["GeneralMarketingMgrID"].ToString();
        }
    ...
    protected void bindDataNextTotalByDate(GridView gv)
    {
        ...
        if (ds != null && !NullData)
        {
            ...
            {
                log.WriteLog(LogUtility.LogErrorLevel.LOG_ERROR, "Format string to float Error.");
                Response.Redirect("~/MarketingMgr/MarketingMgrError.aspx");
            }
    ...
    protected void lbtn_editRSM_Click(object sender, EventArgs e)
    {
        ...
        if (ddlist_country.SelectedItem == null)
        {
            ...
            //By lhy 20110527 ITEM W16 ADD Start
              Response.Redirect("~/BookingSalesData.aspx?SalesOrgID=" + ddlist_salesOrg.SelectedItem.Value.Trim() + "&SegmentID=" + ddlist_segment.SelectedItem.Value.Trim() + "&RSMID=" + ddlist_RSM.SelectedItem.Value.Trim() + "&CountryID=-1&UserID=" + getGeneralMarketingMgrID());
        ...
        else
        {
            ...
            Response.Redirect("~/BookingSalesData.aspx?SalesOrgID=" + ddlist_salesOrg.SelectedItem.Value.Trim() + "&SegmentID=" + ddlist_segment.SelectedItem.Value.Trim() + "&RSMID=" + ddlist_RSM.SelectedItem.Value.Trim() + "&CountryID=" + ddlist_country.SelectedItem.Value.Trim() + "&UserID=" + getGeneralMarketingMgrID());
