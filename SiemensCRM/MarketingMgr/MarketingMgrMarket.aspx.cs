/*
 * File Name   : MarketingMgrMarket.aspx.cs
 * 
...
public partial class MarketingMgr_MarketingMgrMarket : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            log.WriteLog(LogUtility.LogErrorLevel.LOG_ACCESS, "MarketingMgrMarket Access.");
