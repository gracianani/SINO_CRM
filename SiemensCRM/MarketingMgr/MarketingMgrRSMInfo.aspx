<%@ Page Title="User Relation Management" Language="C#" MasterPageFile="~/MarketingMgr/MarketingMgrMasterPage.master"
    AutoEventWireup="true" CodeFile="MarketingMgrRSMInfo.aspx.cs" Inherits="MarketingMgr_MarketingMgrRSMInfo"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div>
        ...
        <tr>
             <td align="center">
             <asp:Label ID="lblSegment" runat="server" Style="text-align:center;" Visible="false" Text="Segment" />
             </td>
             <td align="center">
             <asp:Label ID="lblOperation" runat="server" Style="text-align:center;" Visible="false" Text="Operation" />
             </td>
             <td align="center">
             <asp:Label ID="lblSubRegion" runat="server" Style="text-align:center;" Visible="false" Text="SubRegion" />
             </td>
             </tr>
            <tr>
                <td valign="top">
                        ...
                        <ContentTemplate>
                            <div style="overflow: auto; height: 480px; width: 220px; position: relative; padding-top: 22px;">
                                <asp:GridView ID="gv_customer" runat="server" CellPadding="4" ForeColor="#333333"
                                    ...
                                    OnRowDeleting="gv_customer_RowDeleting" OnRowDataBound="gv_customer_RowDataBound" Style="font-size: 12px;">
                                    <RowStyle BackColor="#EFF3FB" />
                                    <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                                    <PagerStyle BackColor="#2461BF" ForeColor="White" HorizontalAlign="Center" />
                                    <HeaderStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" CssClass="Freezing"/>
                        ...
                        <ContentTemplate>
                            <div style="overflow: auto; height: 480px; width: 220px; position: relative; padding-top: 22px;">
                                <asp:GridView ID="gv_country" runat="server" CellPadding="4" ForeColor="#333333"
                                    ...
                                    OnRowDeleting="gv_country_RowDeleting" OnRowDataBound="gv_country_RowDataBound" Style="font-size: 12px;">
                                    <RowStyle BackColor="#EFF3FB" />
                                    <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                                    <PagerStyle BackColor="#2461BF" ForeColor="White" HorizontalAlign="Center" />
                                    <HeaderStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" CssClass="Freezing"/>
