<%@ Page Title="GR-Sales(Gross Sales)" Language="C#" MasterPageFile="~/MarketingMgr/MarketingMgrMasterPage.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="MarketingMgrGrossSales.aspx.cs" Inherits="MarketingMgr_Default" %>
