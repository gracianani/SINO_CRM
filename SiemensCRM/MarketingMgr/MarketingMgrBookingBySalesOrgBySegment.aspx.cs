...
public partial class MarketingMgr_MarketingMgrBookingBySalesOrgBySegment : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (string.Equals(getRoleID(getRole()), "2"))
        ...
        if (!IsPostBack)
        {
            log.WriteLog(LogUtility.LogErrorLevel.LOG_ACCESS, "MarketingMgrBookingBySalesOrg Access.");
            setDate();
