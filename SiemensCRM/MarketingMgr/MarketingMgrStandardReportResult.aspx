<%@ Page Title="Run" Language="C#" 
    AutoEventWireup="true" CodeFile="MarketingMgrStandardReportResult.aspx.cs" Inherits="MarketingMgrStandardReportResult"
                                ...
                                <td style="width: 1024px" align="left" valign="top">
                                    <div style="width: 100%">
                                          <fieldset class="fie">
                                           ...
                                           <%-- <div  style="width: 980px; overflow: scroll; height: 732px;">--%>
                                                <table>
                                                    <tr>
                                                        <td>
                                                        <div style="overflow: auto; height: 400px; width: 950px; position: relative; padding-top: 22px;">
                                                            <asp:GridView ID="gv_administrator" runat="server" AllowSorting="True" CellPadding="4" AllowPaging="False"
