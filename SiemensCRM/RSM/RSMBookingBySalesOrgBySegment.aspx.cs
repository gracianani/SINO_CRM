...
public partial class RSM_RSMBookingBySalesOrgBySegment : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!string.Equals(getRoleID(getRole()), "4"))
        {
        ...
        if (!IsPostBack)
        {
            log.WriteLog(LogUtility.LogErrorLevel.LOG_ACCESS, "RSMBookingBySalesOrg Access.");
            setDate();
