/*
 * File Name   : RSMSalesChannel.aspx.cs
 * 
...
public partial class RSM_RSMSalesChannel : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            log.WriteLog(LogUtility.LogErrorLevel.LOG_ACCESS, "RSMSalesChannel Access.");
