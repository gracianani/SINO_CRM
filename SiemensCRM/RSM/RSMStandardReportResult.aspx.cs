/*
* File Name   : RSMStandardReportResult.aspx.cs
* 
* Author      : yyan 
* 
...
using Resources;
public partial class RSMStandardReportResult : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            log.WriteLog(LogUtility.LogErrorLevel.LOG_ACCESS, "RSMAccountProfile Access.");
