/*
 *    FileName         :  RSMOperationBookings.aspx.cs
 * 
...
public partial class RSM_Default : System.Web.UI.Page
{
    ...
    protected void btn_search_Click(object sender, EventArgs e)
    {
        ...
        if (str_currency != "")
        {
            label_currency.ForeColor = System.Drawing.Color.Black;
        ...
        {
            label_currency.ForeColor = System.Drawing.Color.Red;
    ...
    //by yyan item8 20110616 add end
    {
        ...
        if (dsPro.Tables[0].Rows.Count > 0 && dsSaleOrg.Tables[0].Rows.Count > 0)
        {
            ...
            DataSet ds_budgetTotal = sql.getBookingsBudgetTotalByOperation(dsPro, ddlist_operation.SelectedItem.Value, getSegmentID(),0);
            DataSet dsOp = sql.getBookingsDataByOperation(dsPro, ddlist_operation.SelectedItem.Value, getSegmentID(),0);
            dsOp.Tables[0].Columns.RemoveAt(0);
            DataSet dsTotalOp = sql.getBookingsDataTotalByOperation(dsPro, ddlist_operation.SelectedItem.Value, getSegmentID(),0);
