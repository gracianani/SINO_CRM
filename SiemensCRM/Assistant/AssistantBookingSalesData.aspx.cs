...
public partial class Assistant_AssistantBookSalesData : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            log.WriteLog(LogUtility.LogErrorLevel.LOG_ACCESS, "AssistantBookingSalesData Access.");
    ...
    protected DataSet getSalesOrgInfo()
    {
        ...
        //By Mbq 20110505 ITEM 1 ADD Start
        string query_salesOrg = "SELECT [SalesOrg].Name, [SalesOrg].Abbr, [SalesOrg].ID FROM [SalesOrg] "
    ...
    */
    ...
    protected DataSet getSegmentInfo(string str_salesOrgID)
    {
        ...
        //                    + str_salesOrgID + "'"
        //                    //by yyan itemw148 20110915 add start 
        //                    + " AND  [Segment].Abbr in (SELECT [Segment].Abbr FROM [User_Segment] "
        //                    + " INNER JOIN [Segment] ON [Segment].ID = [User_Segment].SegmentID "
        //                    + " WHERE UserID = " + Session["AssistantID"].ToString() + " AND [Segment].deleted=0 AND [User_Segment].deleted=0 ) "
        //                    //by yyan itemw148 20110915 add end 
        //                    + " ORDER BY [Segment].Abbr ASC";
        ////By Mbq 20110505 ITEM 1 ADD End
    ...
    protected string getAssistantID()
    {
        return Session["AssistantID"].ToString().Trim();
    }
    ...
    private string getCountrySQL()
    {
        ...
        string query_country = " SELECT [SubRegion].ID"
            ...
            + " WHERE [User_Country].UserID  = '" + getAssistantID() + "'"
    ...
    {
        string query_RSM = " SELECT Abbr FROM [User] WHERE Deleted = 0 AND UserID = '" + str_userID + "'";
        DataSet ds_RSM = helper.GetDataSet(query_RSM);
    ...
    protected void btn_search_Click(object sender, EventArgs e)
    {
        ...
        if (this.ddlist_RSM.Items.FindByValue(Session["AssistantID"].ToString()) != null)
        {
            this.ddlist_RSM.SelectedValue = Session["AssistantID"].ToString();
        }
    ...
    private void setImageEnabled(string str_userID, string str_segmentID)
    {
