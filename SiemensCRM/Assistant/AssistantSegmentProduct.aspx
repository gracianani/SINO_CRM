<%@ Page Title="Segment Product" Language="C#" MasterPageFile="~/Assistant/AssistantMasterPage.master"
    AutoEventWireup="true" CodeFile="AssistantSegmentProduct.aspx.cs" Inherits="AssistantSegmentProduct" EnableSessionState="ReadOnly" %>
                ...
                <div style="overflow: auto; height: 200px; width: 767px; position: relative; padding-top: 22px;">
                  <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    ...
                    <asp:GridView ID="gv_product" runat="server" CellPadding="4" ForeColor="#333333"
                        ...
                        <EditRowStyle BackColor="#33CCCC" />
                        <AlternatingRowStyle BackColor="White" CssClass="Freezing"/>
                    </asp:GridView>
                      </ContentTemplate>
                 </asp:UpdatePanel>
                    </div>
