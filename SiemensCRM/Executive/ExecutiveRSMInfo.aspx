<%@ Page Title="User Relation Management" Language="C#" MasterPageFile="~/Executive/ExecutiveMasterPage.master"
    AutoEventWireup="true" CodeFile="ExecutiveRSMInfo.aspx.cs" Inherits="Executive_ExecutiveRSMInfo"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table>
        <tr>
            ...
            <td align="center">
                <asp:Label ID="lblOperation" runat="server" Style="text-align: center;" Visible="false"
                    Text="Operation" />
            </td>
            <td align="center">
                <asp:Label ID="lblSubRegion" runat="server" Style="text-align: center;" Visible="false"
                    Text="SubRegion" />
            </td>
        </tr>
        <tr>
            ...
            <td valign="top">
                <asp:UpdatePanel ID="UpdatePanel4" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <div style="overflow: auto; height: 400px; width: 220px; position: relative; padding-top: 22px;">
