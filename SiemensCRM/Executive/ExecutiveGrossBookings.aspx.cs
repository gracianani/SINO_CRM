/*
 * File Name   : ExecutiveGrossBookings.aspx.cs
 * 
 * Description : Get bookings data by operation
 * 
 * Author      : Wang Jun
 * 
...
public partial class Executive_ExecutiveGrossBookings : System.Web.UI.Page
{
        ...
        if (dsPro.Tables[0].Rows.Count > 0 && dsOp.Tables[0].Rows.Count > 0)
        {
            ...
            for (int count = 0; count < dsOp.Tables[0].Rows.Count; count++)
            {
                ...
                if (ds[count].Tables[0].Rows.Count > 0)
                {
                    ...
                    //by yyan item8 20110622 start end
