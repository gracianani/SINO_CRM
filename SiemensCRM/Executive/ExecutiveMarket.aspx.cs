/*
 * File Name   : ExecutiveMarket.aspx.cs
 * 
...
public partial class Executive_ExecutiveMarket : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            log.WriteLog(LogUtility.LogErrorLevel.LOG_ACCESS, "ExecutiveMarket Access.");
