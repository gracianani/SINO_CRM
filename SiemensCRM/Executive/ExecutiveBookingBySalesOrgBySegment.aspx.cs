...
public partial class Executive_ExecutiveBookingBySalesOrgBySegment : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        // By DingJunjie 20110517 Item 52 Delete Start
        // if (getRoleID(getRole()) == "0" || getRoleID(getRole()) == "5")
        // By DingJunjie 20110517 Item 52 Delete End
        // By DingJunjie 20110517 Item 52 Add Start
        if (string.Equals(getRoleID(getRole()), "1"))
        // By DingJunjie 20110517 Item 52 Add End
        {
        ...
        if (!IsPostBack)
        {
            log.WriteLog(LogUtility.LogErrorLevel.LOG_ACCESS, "ExecutiveBookingBySalesOrg Access.");
            setDate();
